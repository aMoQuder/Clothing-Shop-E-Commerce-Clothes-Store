...
$(document).ready(function() {
    // تأكد من أن <p> قابل للتحرير
    $('.summernote p').attr('contenteditable', 'true');

    // تعيين القيمة الابتدائية لـ input المخفي عند تحميل الصفحة
    $('#Description').val($('.summernote p').text());

    // أضف مستمع الحدث لتحديث قيمة input المخفي عند تغيير النص داخل <p>
    $('.summernote p').on('input', function() {
        $('#Description').val($(this).text());
    });

    // تحديث قيمة input المخفي عند تقديم النموذج
